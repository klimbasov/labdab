...
public:
	overclothes(){}
	overclothes(char * OIC, char* CIC):oveclothes_init_code(OIC){
		clothes_init_code = CIC;
	}
	~overclothes() {
...
public:
	underwear(){}
	underwear(char* UIC, char* CIC):underwear_init_code(UIC) {
		clothes_init_code = CIC;
	}
	~underwear() {
...
public:
	briefs() {}
	briefs(char* BIC, char* OIC, char* CIC) :briefs_init_code(BIC){
		oveclothes_init_code = OIC;
		clothes_init_code = CIC;
	}
	~briefs() {
...
public:
	pants(){}
	pants(char* PIC, char* UIC, char* CIC) :pants_init_code(PIC){
		underwear_init_code = UIC;
		clothes_init_code = CIC;
	}
	~pants() {
...
public:
	boxing_truncs() {}
	boxing_truncs(char* BTIC, char* PIC, char* BIC,char* UIC, char* OIC, char* CIC) :boxing_truncs_init_code(BTIC){
		pants_init_code = PIC;
